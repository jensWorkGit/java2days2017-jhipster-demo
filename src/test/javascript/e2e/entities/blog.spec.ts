...
describe('Blog e2e test', () => {
    ...
    it('should load Blogs', () => {
        ...
        expect(blogComponentsPage.getTitle()).toMatch(/java2DaysApp.blog.home.title/);
    ...
    it('should load create Blog dialog', () => {
        ...
        expect(blogDialogPage.getModalTitle()).toMatch(/java2DaysApp.blog.home.createOrEditLabel/);
