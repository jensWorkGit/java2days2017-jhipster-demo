...
describe('Entry e2e test', () => {
    ...
    it('should load Entries', () => {
        ...
        expect(entryComponentsPage.getTitle()).toMatch(/java2DaysApp.entry.home.title/);
    ...
    it('should load create Entry dialog', () => {
        ...
        expect(entryDialogPage.getModalTitle()).toMatch(/java2DaysApp.entry.home.createOrEditLabel/);
