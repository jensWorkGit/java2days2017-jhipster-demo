...
describe('Tag e2e test', () => {
    ...
    it('should load Tags', () => {
        ...
        expect(tagComponentsPage.getTitle()).toMatch(/java2DaysApp.tag.home.title/);
    ...
    it('should load create Tag dialog', () => {
        ...
        expect(tagDialogPage.getModalTitle()).toMatch(/java2DaysApp.tag.home.createOrEditLabel/);
        tagDialogPage.close();
    });
